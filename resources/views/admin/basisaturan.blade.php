                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h6 class="m-0 font-weight-bold text-primary">Data BasisAturan</h6>
                                    <div>
                                        <a href="{{ route('admin.tambahbasisaturan') }}"
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody class="table-group-divider">
                                                @foreach ($data->reverse() as $basisaturan)
                                                <tr>
                                                    <td>{{ $basisaturan->namapenyakit }}</td>
                                                    <td>{{ $basisaturan->keterangan }}</td>
                                                    <td>
                                                        <div class="d-flex justify-content-end">
                                                            <a href="{{ route('admin.detailbasisaturan', $basisaturan->id) }}"
                                                                class="appointment-btn scrollto">Detail</a>
                                                            <a href="{{ route('admin.editbasisaturan', $basisaturan->id) }}"
                                                                class="appointment-btn scrollto">Edit</a>
                                                            <a class="delete-btn"
                                                                href="/admin/hapusbasisaturan/{{ $basisaturan->id }}">Delete</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                                @endforeach
