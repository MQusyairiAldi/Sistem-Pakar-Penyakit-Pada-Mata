                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h6 class="m-0 font-weight-bold text-primary">Detail Basis Aturan</h6>

                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <!-- Mengakses namapenyakit dari data pertama -->
                                        <label for="">Nama Penyakit</label>
                                        <input type="text" value="{{ $data->first()->namapenyakit }}"
